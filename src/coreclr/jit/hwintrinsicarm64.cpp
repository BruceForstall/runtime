        ...
        case NI_Vector128_ExtractMostSignificantBits:
            {
                ...
                else
                {
                    ...
                    {
                        op1 = gtNewSimdHWIntrinsicNode(TYP_SIMD8, op1, NI_AdvSimd_Arm64_AddPairwiseScalar,
        ...
        case NI_AdvSimd_Arm64_StoreSelectedScalar:
            {
                ...
                else
                {
                    ...
                    // Thus, we get simdSize as 8 for both of the calls. We re-calculate that simd size for such API
                    // calls.
        ...
        case NI_AdvSimd_Arm64_LoadPairVector64NonTemporal:
            {
                ...
                retNode =
                    impStoreMultiRegValueToVar(op1, sig->retTypeSigClass DEBUGARG(CorInfoCallConvExtension::Managed));
                break;
            }
        case NI_AdvSimd_LoadAndInsertScalarVector64x2:
        case NI_AdvSimd_LoadAndInsertScalarVector64x3:
