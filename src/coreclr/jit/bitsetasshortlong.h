                ...
                /*BitSetTraits*/ BitSetTraits>
{
    ...
    public:
        ...
        //
        template <typename TFunc> static bool VisitBits(Env env, BitSetShortLongRep bs, TFunc func)
        {
#ifdef HOST_64BIT
...
#undef BitScanForwardSizeT
        ...
        //   and iteration was aborted.
        //
        template <typename TFunc> static bool VisitBitsReverse(Env env, BitSetShortLongRep bs, TFunc func)
        {
#ifdef HOST_64BIT
