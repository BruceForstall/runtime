                    ...
                    case NI_Quaternion_Inverse:
                        {
                            ...
                            GenTree* conjugate =
                                gtNewSimdBinOpNode(GT_MUL, retType, op1, vecCon, simdBaseJitType, simdSize);
                    ...
                    case NI_VectorT_ConvertToDouble:
                        {
                            ...
                            return gtNewSimdHWIntrinsicNode(retType, op1, NI_AdvSimd_Arm64_ConvertToDouble,
                    ...
                    case NI_Vector4_Lerp:
                        {
                            ...
                            // clonedOp3 = op3
                            GenTree* clonedOp3;
                            op3 = impCloneExpr(op3, &clonedOp3, CHECK_SPILL_ALL,
                    ...
                    case NI_Vector2_Create:
                        {
                            ...
                            else
                            {
                                ...
                                copyBlkSrc = gtNewSimdHWIntrinsicNode(TYP_SIMD8, std::move(nodeBuilder),
                                                                      NI_Vector128_Create, simdBaseJitType, 16);
#elif defined(TARGET_ARM64)
                                copyBlkSrc = gtNewSimdHWIntrinsicNode(TYP_SIMD8, op2, op3, NI_Vector64_Create,
                                                                      simdBaseJitType, 8);
#else
#error Unsupported platform
#endif // !TARGET_XARCH && !TARGET_ARM64
                    ...
                    case NI_Vector3_Create:
                        {
                            ...
                            else
                            {
                                ...
                                copyBlkSrc = gtNewSimdHWIntrinsicNode(TYP_SIMD12, std::move(nodeBuilder),
                                                                      NI_Vector128_Create, simdBaseJitType, 16);
                            }
                    ...
                    case NI_Vector4_Create:
                        {
                            ...
                            else
                            {
                                ...
                                copyBlkSrc = gtNewSimdHWIntrinsicNode(TYP_SIMD16, std::move(nodeBuilder),
                                                                      NI_Vector128_Create, simdBaseJitType, 16);
                            }
