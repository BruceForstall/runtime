        ...
        case NI_AVX512BW_ShiftRightLogical:
            {
                ...
                return gtNewSimdHWIntrinsicNode(simdType, op1, tmpOp, intrinsic, simdBaseJitType,
        ...
        case NI_Vector512_AsVector512:
            {
                ...
                if (vectorTByteLength == YMM_REGSIZE_BYTES)
                {
                    ...
                    else
                    {
                        ...
                        return impSpecialIntrinsic(NI_Vector256_ToVector512, clsHnd, method, sig, simdBaseJitType,
                                                   retType, 32);
                    }
                    break;
                }
                        ...
                        case TYP_USHORT:
                            {
                                ...
                                assert((simdSize == 16) || (simdSize == 32) || (simdSize == 64));
                                simdBaseJitType =
                                    varTypeIsUnsigned(simdBaseType) ? CORINFO_TYPE_UBYTE : CORINFO_TYPE_BYTE;
                                ...
                                op1 = impSIMDPopStack();
                                op1 = gtNewSimdHWIntrinsicNode(simdType, op1, op2, shuffleIntrinsic, simdBaseJitType,
                                                               simdSize);
                                ...
                                if (simdSize == 32)
                                {
                                    ...
                                    // Since Vector256 is 2x128-bit lanes we need a full width permutation so we get the
                                    // lower 64-bits of each lane next to eachother. The upper bits should be zero, but
                                    // also don't matter so we can also then simplify down to a 128-bit move mask.

                                    simdOtherJitType =
                                        (simdBaseType == TYP_UBYTE) ? CORINFO_TYPE_ULONG : CORINFO_TYPE_LONG;

                                    op1 = gtNewSimdHWIntrinsicNode(simdType, op1, gtNewIconNode(0xD8),
                                                                   NI_AVX2_Permute4x64, simdOtherJitType, simdSize);
        ...
        case NI_SSE_CompareScalarNotGreaterThanOrEqual:
            {
                ...
                else
                {
                    ...
                    retNode = gtNewSimdHWIntrinsicNode(TYP_SIMD16, clonedOp1, retNode, NI_SSE_MoveScalar,
                                                       simdBaseJitType, simdSize);
                }
                break;
            }
        ...
        case NI_AVX512F_VL_TernaryLogic:
            {
                ...
                if (op4->IsIntegralConst())
                {
                    ...
                    if (useFlags != TernaryLogicUseFlags::ABC)
                    {
                            ...
                            case TernaryLogicOperKind::Not:
                                {
                                    ...
                                    if (info.oper2 == TernaryLogicOperKind::And)
                                    {
                                        ...
                                        // GT_AND_NOT takes them as `op1 & ~op2` and x86 reorders them back to `~op1 &
                                        // op2` since the underlying andnps/andnpd/pandn instructions take them as such

                                        return gtNewSimdBinOpNode(GT_AND_NOT, retType, *val3, *val2, simdBaseJitType,
                                                                  simdSize);
                                    }
                                    else
                                    {
                        ...
                        retNode =
                            gtNewSimdTernaryLogicNode(retType, *val1, *val2, *val3, op4, simdBaseJitType, simdSize);
                        break;
                    }
                }
        ...
        case NI_AVX512BW_BlendVariable:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(retType, op1, op2, op3, NI_AVX512F_BlendVariableMask,
                                                   simdBaseJitType, simdSize);
                break;
            }
        ...
        case NI_AVX512BW_CompareEqual:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareEqualMask, simdBaseJitType,
                                                   simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX512BW_VL_CompareGreaterThan:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareGreaterThanMask,
                                                   simdBaseJitType, simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX512BW_VL_CompareLessThan:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareLessThanMask, simdBaseJitType,
                                                   simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX512BW_VL_CompareNotEqual:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareNotEqualMask, simdBaseJitType,
                                                   simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX512F_CompareNotLessThan:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareNotLessThanMask,
                                                   simdBaseJitType, simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX512F_CompareOrdered:
            {
                ...
                retNode = gtNewSimdHWIntrinsicNode(TYP_MASK, op1, op2, NI_AVX512F_CompareOrderedMask, simdBaseJitType,
                                                   simdSize);
                retNode = gtNewSimdHWIntrinsicNode(retType, retNode, NI_AVX512F_ConvertMaskToVector, simdBaseJitType,
                                                   simdSize);
        ...
        case NI_AVX2_GatherMaskVector256:
            {
                ...
                retNode =
                    new (this, GT_HWINTRINSIC) GenTreeHWIntrinsic(retType, getAllocator(CMK_ASTNode), intrinsic,
