...
class CodeGen final : public CodeGenInterface
{
    ...
    private:
        ...
        void* genCreateAndStoreGCInfo(unsigned            codeSize,
                                      unsigned            prologSize,
    ...
    protected:
        ...
        struct FuncletFrameInfoDsc
        {
                ...
                int fiFunction_CallerSP_to_FP_delta; // Delta between caller SP and the frame pointer in the parent
                                                     // function (negative)
    ...
    protected:
        ...
        class HWIntrinsicImmOpHelper final
        {
            ...
            private:
                // Returns true if immOp is non contained immediate (i.e. the value of the immediate operand is
                // enregistered in nonConstImmReg).
