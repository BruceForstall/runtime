        ...
        class VariableLiveKeeper
        {
...
#ifdef DEBUG
                        // Dump "VariableLiveRange" when code has not been generated. We don't have the native code
                        // offset, but we do have "emitLocation"s and "siVarLoc".
                        void dumpVariableLiveRange(const CodeGenInterface* codeGen) const;

                        // Dump "VariableLiveRange" when code has been generated and we have the native code offset of
                        // each "emitLocation"
            ...
            private:
                ...
                VariableLiveDescriptor* m_vlrLiveDscForProlog; // Array of descriptors that manage VariableLiveRanges.
                                                               // Its indices correspond to lvaTable indexes (or
                                                               // lvSlotNum).
            ...
            public:
                ...
                void siStartOrCloseVariableLiveRange(const LclVarDsc* varDsc,
                                                     unsigned int     varNum,
                                                     bool             isBorn,
                                                     bool             isDying);
