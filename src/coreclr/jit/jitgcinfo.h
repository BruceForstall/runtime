...
class GCInfo
{
    ...
    public:
        ...
        // depending on whether "newState" is "GC_SLOT_DEAD" or "GC_SLOT_LIVE".  The subset of registers whose
        // corresponding bits are set in "byRefMask" contain by-refs rather than regular GC pointers. "*pPtrRegs" is the
        // set of registers currently known to contain pointers.  If "mode" is "ASSIGN_SLOTS", computes and records slot
