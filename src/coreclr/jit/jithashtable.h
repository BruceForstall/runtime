...
class JitHashTable
{
    public:
        ...
        //
        template <class... Args> Value* Emplace(Key k, Args&&... args)
        {
            CheckGrowth();
    ...
    public:
        ...
        void Reallocate(unsigned newTableSize)
        {
            ...
            m_tableMax      = (unsigned)(newTableSize * Behavior::s_density_factor_numerator /
                                    Behavior::s_density_factor_denominator);
        }
...
template <typename T> struct JitKeyFuncsDefEquals
{
...
template <typename T> struct JitPtrKeyFuncs : public JitKeyFuncsDefEquals<const T*>
{
    public:
