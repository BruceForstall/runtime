...
template <class T> class JitExpandArray
{
    protected:
...
template <class T> class JitExpandArrayStack : public JitExpandArray<T>
{
...
//
template <class T> void JitExpandArray<T>::EnsureCoversInd(unsigned idx)
{
    if (idx >= m_size)
    {
